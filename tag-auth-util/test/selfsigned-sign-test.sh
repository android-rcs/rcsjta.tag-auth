...
java -jar ../build/iaritool.jar -generate -keyalg RSA -alias iari-self-signed-test -keystore keys/iari-self-signed-test.jks -storepass secret -keypass secret -dname CN=iari.self-signed.test -validity 360 -keysize 2048 -dest iari-self-signed-authorization.xml -v
